			...
			<section id="clients">
				<div class="container">
							...
							<div class="panel panel-default">
								<div id="panel-heading" class="panel-heading">
									<h2 id="clientes_titulo" class="panel-title">
										<i class="fa fa-list-alt"></i> Relatório de Produtos ordenados por maior valor no estoque
									</h2>
								</div>
                    ...
                    ?>
									...
									<div class="row">
										<div clas="col-md-4">
											<form name="excel.php" action="../download/maior_valor_estoque.php" method="post">
