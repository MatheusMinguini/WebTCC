			...
			<section id="clients">
				<div class="container">
							...
							<div class="panel panel-default">
								<div id="panel-heading" class="panel-heading">
									<h2 id="clientes_titulo" class="panel-title">
										<i class="fa fa-list-alt"></i> Relatório do valor Investido com o estoque por período
									</h2>
								</div>
									...
									<table class="table table-bordered">
										<thead id="titulo">
											<tr>
												...
												<th id="opcoes"><center><i class="fa fa-user"></i> Grupo</center></th>
                        <th id=""><center><i class="fa fa-usd"></i> Valor investido</center></th>
                                ...
                                $sql = mysql_query(
																"SELECT g.nome, SUM(p.valor_total) from grupo g
                                  INNER JOIN produto p ON p.grupo = g.codigo
                                    WHERE p.data_entrada between '$data_inicial' and '$data_final'
																		AND p.vendido = 'n'
                                    GROUP BY g.nome
                                    Order BY g.nome; "
																);
                    ...
                    ?>
                        ...
                        <td>
												R$	<?=number_format($linha['SUM(p.valor_total)'],2,',','.')?>
												</td>
