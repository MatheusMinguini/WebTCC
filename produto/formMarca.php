					...
					<div class="panel panel-default">
						<div id="panel-heading" class="panel-heading">
							<h2 id="clientes_titulo" class="panel-title">
								<i class="glyphicon glyphicon-tag"></i> Marca
							</h2>
							<a href="index_produto.php" id="botao-adicionar"
								class="btn btn-default"><i class="fa fa-reply"></i> Voltar</a>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" action="cadastro_marca.php"
								method="post">
								<div class="form-group">
									<div class="col-md-4">
										<label>Marca</label>
										<input type="text" name="marca" class="form-control" placeholder="marca" maxlength="30">
									</div>
									<div class="col-md-4">
										<label>Confirme a marca a ser cadastrada</label>
										<input type="text" name="confmarca" class="form-control" placeholder="Confirma a marca" maxlength="30">
									</div>
								</div>
								<br>
								<div class="row">
