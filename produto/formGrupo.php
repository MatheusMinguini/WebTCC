					...
					<div class="panel panel-default">
						<div id="panel-heading" class="panel-heading">
							<h2 id="clientes_titulo" class="panel-title">
								<i class="glyphicon glyphicon-floppy-disk"></i> Grupo de
								produtos
							</h2>
						...
						<div class="panel-body">
							<form class="form-horizontal" action="cadastro_grupo.php"
								method="post">
								<div class="form-group">
									...
									<div class="col-md-4">
										<label>* Confirme o nome do grupo</label>
										<input required type="text" name="confnome" class="form-control" placeholder="Confirma o nome do grupo" maxlength="25">
									</div>
								</div>
								<br>
								<div class="row">
