							...
							<div class="panel panel-default">
								<div id="panel-heading" class="panel-heading">
									<h2 id="clientes_titulo" class="panel-title">
										<i class="fa fa-list-alt"></i> Relatório do total de vendas por período
									</h2>
								</div>
									...
									<table class="table table-bordered">
										<thead id="titulo">
											<tr>
												...
												<th id="opcoes">
                          <center><i class="fa fa-usd"></i> Valor total de venda</center>
                        </th>
                    ...
                    ?>
                            ...
                            ?>
										<tbody>
											<tr>
												<td>
												R$	<?=number_format($linha['SUM(total)'], 2, ',', '.');?>
												</td>
