					...
					<div class="panel panel-default">
						<div id="panel-heading" class="panel-heading">
							<h2 id="clientes_titulo" class="panel-title">
								<i class="fa fa-tag"></i> Grupo menos vendido
							</h2>
						</div>
						<div class="panel-body">
							<table class="table table-bordered">
								<thead id="titulo">
									<tr>
										<th id="opcoes">
											<center>Grupo menos vendido</center>
										</th>
										<th>
                            ...
                            ?>
								<tbody>
									<tr>
										...
										<td>
											<a id="link_cliente" href="?codigo=<?=$linha['codigo']?>"><?=$linha['nome']?></a>
										</td>
                    <td>
											<a id="link_cliente" href="?codigo=<?=$linha['codigo']?>"> R$ <?=number_format($linha['SUM(v.total)'],2, ',','.')?></a>
										</td>
									</tr>
								</tbody>
								<?php
